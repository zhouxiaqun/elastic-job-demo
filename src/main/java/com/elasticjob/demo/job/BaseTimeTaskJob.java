package com.elasticjob.demo.job;
...
public class BaseTimeTaskJob {
     ...
     *
     * @param jobName 任务名称（不写默认为spring配置中的id）
     */
     ...
     *
     * @param shardingItemParameters 分片序列号和参数用等号分隔，多个键值对用逗号分隔 分片序列号从0开始，不可大于或等于作业分片总数 如： 0=a1=b2=c
     */
     ...
     *
     * @param failover 是否开启失效转移 仅monitorExecution开启，失效转移才有效
     */
     ...
     *
     * @param jobProperties 作业定制化属性，目前支持job_exception_handler和executor_service_handler，用于扩展异常处理和自定义作业处理线程池
     */
